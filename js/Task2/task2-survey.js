...
function initPreviewModal() {
  ...
  const defaults = {
    modeA: { src: "../assets/task2-mode-a.png", title: "Mode A — Overload", alt: "Task 2 Overload Mode screenshot" },
    modeB: { src: "../assets/task2-mode-b.png", title: "Mode B — Zen",      alt: "Task 2 Zen Mode screenshot" }
  };
...
function buildPayload(formData) {
  ...
  const overloadRec = task2Tasks.find(t => t.mode === "overload" || t.version === "versionA");
  const zenRec      = task2Tasks.find(t => t.mode === "zen"      || t.version === "versionB");
  ...
  return {
    ...
    survey: {
      ...
      t2_A_submitConfidence: parseInt(formData.get("q2_overload_confidence"), 10) || "",
      t2_B_submitConfidence: parseInt(formData.get("q2_zen_confidence"),      10) || "",
